...
from sample.model.DisjunctiveNormalForm import *
...
class ModelIOTests(unittest.TestCase):
    ...
    def test_in_is_out(self):
        ...
        file_path = "G:/Github/BA-Jan/newOrganisation/test_files/inhibitions-1.crs"
        test_path = "G:/Github/BA-Jan/newOrganisation/test_results/result.crs"
        res_lines = []
